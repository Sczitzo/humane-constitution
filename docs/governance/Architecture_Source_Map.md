...
| Accumulated advantage can compound over time. | [Thomas Piketty, Capital in the Twenty-First Century](https://www.hup.harvard.edu/books/9780674430006) | Long-run accumulation and inherited advantage can produce concentration dynamics that require structural attention. | It does not prove Commons Return, Universal Stake, decay, or anti-rent rules will be fair, effective, or politically legitimate. | Level 3 — Internal consistency review |
...
- Commons Return and Universal Stake have been proven fair or effective;
