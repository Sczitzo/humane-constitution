...
| 5 | Commons Return and Universal Stake simulation | Can shared/scarcity-created value fund public rails and a non-convertible Universal Stake without burdening ordinary life or creating capture routes? | No hidden tax burden, eligibility gate, valuation-hiding path, routing-capture route, or sector-capture route dominates. |
...
| Anti-rent enforcement against legal wrappers | Phase 7 | Phase 5 CRUS valuation and eligibility tests; Phase 9 elite proxy markets |
...
| Power-Wealth Convergence | Phase 5 Commons Return and Universal Stake; Phase 6 public banking rails; Phase 7 anti-rent and ownership review; Phase 8 conglomerate transition; Phase 9 governance red-team | Public procurement integrity, beneficial-ownership review, FAP capture testing, and sector concentration dashboards |
| Static-Advantage Loop | Phase 1 public understanding; Phase 7 anti-rent and ownership review; Phase 9 governance red-team | Service Record Misuse Evidence Test Package, premium-access drift, CRUS incidence by class, founding legitimacy, and subsidiarity drift |
...
| Independent civil-society review | Phase 5 (Commons Return and Universal Stake simulation) — public-finance and distribution architecture requires external legitimacy review before real-money simulation |
...
**Test population:** General public readers with no policy, economics, crypto, or governance background.

**Measure:**

- Can readers explain Flow, Essential Access, Voice, Service Record, and Shared Storehouse in their own words?
...
- Readers interpret Voice or Service Record as social credit.
...
- Any user can lose survival access because an identity dispute is unresolved.
...
- measurement error by essential category
- update latency
...
- Access depends on staff goodwill.
...
## Phase 5 - Commons Return and Universal Stake simulation
...
- ordinary-user incidence
- concentrated-source-holder incidence
- transaction volume
- savings behavior
- source-base coverage and leakage
- public-rail operating revenue
- valuation-hiding pressure by sector
- Universal Stake eligibility accuracy
- Universal Stake non-convertibility
- distribution cadence and payment failures
- routing-capture and patronage signals
- external-capital arbitrage
...
- public comprehension of source bases, who pays, who receives, where revenue goes, and what protections ordinary life receives

**Failure criteria:**

- Commons Return incidence falls on ordinary households, renters, small stewards, or protected associations more than concentrated control of source bases.
- Actors create exemptions, valuation discounts, eligibility categories, or routing rules that become capture channels.
...
- Universal Stake can be sold, assigned, pledged, garnished, or converted into Voice, office, survival priority, membership, legal standing, or public favor.
- Commons Return becomes politically or practically equivalent to a hidden tax on ordinary liquidity.
- Project escrow becomes a favored-sector parking channel despite the zero-exemption rule.
- Users cannot explain source bases, distribution rights, non-convertibility walls, appeal paths, or the difference between ordinary life and shared/scarcity-created value after public disclosure.

**Scale rule:** Commons Return and Universal Stake should remain a simulation and pilot parameter until incidence, dignity, valuation, eligibility, routing, and non-convertibility risks are transparent.
...
- Poor users receive slower, weaker, or more surveilled service.
...
- family-office workaround routes
- trust and foundation control paths
...
- Wealth continues to extract value through legal wrappers.
...
- Capture succeeds quietly.
- Review bodies protect each other.
...
- Commons Return incidence and Universal Stake distribution simulations
