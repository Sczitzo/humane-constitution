...
| 3 | Cross-instrument convertibility | Survival-Trade Bind; Power-Wealth Convergence; Static-Advantage Loop | **Active — unproven** | T-001, T-004, T-025, Annex AJ, Annex D, Annex Z, CRUS Evidence Test Package, Service Record Misuse Evidence Test Package | Test compound bundles across housing, employment, lending, platforms, household control, identity recovery, Universal Stake, Essential Access, Voice, and Service Record. The question is not whether one lane converts directly; it is whether actors can chain lanes until survival, civic standing, identity recovery, or member distribution becomes practically tradable. |
| 4 | Contribution without coercive hierarchy | Static-Advantage Loop | **Designed** | T-004, T-008, T-009, Annexes AC, AF, Z, AS | Use the Service Record Misuse Evidence Test Package to test non-civic misuse, contribution-category equity, attestation markets, hardship freeze abuse, public comprehension, civic-pool concentration, and network-class dominance. |
| 5 | Anti-rent enforcement against legal wrappers | Power-Wealth Convergence; Static-Advantage Loop | **Designed** | P-031, P-032, P-033, T-025, Annexes J, AR | Red-team trusts, family offices, beneficial ownership chains, land-control rights, and enterprise-control workarounds. |
| 6 | Founding legitimacy and consent | Power-Wealth Convergence; Static-Advantage Loop | **Proposed** | T-017, T-022, T-026, T-027, Founding Order, Annex AH, Founding Legitimacy Dossier | Two artifacts in the Founding Legitimacy Dossier remain at UNRESOLVED-PREREQUISITE status: "consent evidence" (the definition of what counts as genuine non-coercive consent has not been publicly committed) and "independent civil-society review" (who qualifies as civil society for Level 7 legitimacy review has not been defined). These are not production delays — they are definitional prerequisites that must be resolved before any production work can begin. Status is Proposed, not Designed: the mechanism exists in theory but cannot be produced without resolving these definitions. |
| 7 | Bureaucratic complexity and institutional self-protection | Static-Advantage Loop; Power-Wealth Convergence | **Active — unproven** | T-005, T-008, T-016, P-025, Annexes AI, AG, AV | Test whether review bodies protect people or protect themselves; measure ordinary-reader comprehension of authority paths. |
| 8 | Essential-sector conglomerate refusal and retaliation | Survival-Trade Bind; Power-Wealth Convergence | **Active — unproven** | Annex AT §AT6.6 (CASP), Annex AR, Conglomerate Transition Dossier, Essential-Sector Refusal Test Package, Capture Dashboard Specification | CASP pre-registration mechanism is ACTIVE (P-050). Run the largest-supplier exit, medicine/PBM refusal, and grid/logistics delay drills before any stronger claim that essential-sector hostage power is controlled. |
| 9 | Implementation drift and tamper evidence | Control-plane failure | **Designed** | architecture files, INVARIANTS, Annex AV | Use the Implementation Drift Audit Package to test hash reproducibility, publication-channel divergence, startup refusal, key custody, timelock response, and supply-chain bypass. |
| 10 | Fiscal and monetary architecture | Power-Wealth Convergence; Survival-Trade Bind | **Proposed** (gap — no registered threat) | ANS N-014; ANNEX_D (Commons Return and Universal Stake); P-029 PFCR [Active — unproven]; CRUS Evidence Test Package; Parameter Calibration Register CRUS gates | The corpus now names CRUS fiscal-adequacy, pass-through, downturn, leakage, administrative-cost, capture, incentive, dignity, and pilot-falsification gates, but no costed CRUS revenue base, public-rail operating model, Universal Stake distribution model, monetary interface, or registered currency-debasement threat has been produced. Public-return streams may narrow or replace some ordinary-life taxes only after those gates pass for named obligations; they cannot do so by assertion. Define a fiscal architecture and register a debasement / fiscal-sustainability threat before any scale claim. (Surfaced by the Adversarial Narrative Simulation panel.) |
| 11 | External cyber resilience and availability | Control-plane failure; Survival-Trade Bind | **Proposed** (gap — no registered threat) | ANS N-015; Annex AV (drift/tamper only) | Drift/tamper (rank 9) is covered; external *availability* is not — ransomware, key compromise under breach, population-scale outage, offline continuity. Specify key-management-under-breach, outage continuity, and an availability threat distinct from internal capture. |
| 12 | Floor of last resort for the unenrolled | Survival-Trade Bind | **Proposed** (gap) | ANS N-011; T-002, P-003 (cover loss/recovery, not never-enrolled) | Identity assurance assumes a person already inside the digital system. Specify a tested analog/offline path so someone who can never hold a credential still reaches the survival floor. |
| 13 | The enforcement-observation paradox | Power-Wealth Convergence | **Proposed** (gap) | ANS N-012 | Enforcing non-convertibility and the floor requires continuous monitoring — itself the surveillance surface the design opposes. No technical (e.g. zero-knowledge) resolution is specified; only procedural/custodial controls. Specify what limits monitoring repurposing, or accept and document the residual openly. |
...
| 3 | A cross-instrument red team produces a repeatable bundle where housing, employment, lending, platform access, household control, identity recovery, Universal Stake, Essential Access, Voice, or Service Record becomes conditional on another protected lane. | Keep non-convertibility claims **Active — unproven**; revise lane boundaries, data exposure, reporting protection, and broker-focused enforcement before strengthening any claim. |
| 4 | Service Record red team shows employers, landlords, schools, vendors, platforms, lenders, insurers, or attestation markets can convert civic status into rank. | Keep contribution controls **Designed**; revise non-civic misuse barriers and equity tests before evidence-backed status. |
| 5 | Legal-wrapper red team preserves rent or control through trusts, beneficial ownership chains, land-control rights, or enterprise-control proxies. | Keep anti-rent enforcement **Designed**; add wrapper-specific controls and rerun the red team before stronger claims. |
| 6 | Founding artifacts lack real public notice, objection/abstention evidence, exit rehearsal, consent evidence, conflict disclosure, or independent review. | Block activation-legitimacy claims; record the residual legitimacy risk in the founding evidence track. |
| 7 | Review bodies protect institutional discretion, confuse ordinary users, or show concentrated voting, staffing, or funding dependence. | Keep the item **Active — unproven**; require corrective action before the governance cycle closes. |
| 8 | Largest-supplier, medicine/PBM, grid, or logistics refusal drill cannot preserve the Constitutional Survival Minimum before reserves or fallback capacity fail. | Block claims that essential-sector hostage power is controlled; revise reserves, fallback production, procurement, or trade-membrane design. |
| 9 | Hash, publication-channel, startup-refusal, key-custody, timelock, or supply-chain drill allows silent drift or bypass. | Treat the control plane as failed or **Active — unproven**; patch before launch or the next public release. |
| 10 | A costing exercise shows CRUS cannot fund the named obligation or ordinary-tax-narrowing claim after administrative cost, appeals, reserves, downturn haircuts, pass-through, and avoidance; or no costing model is produced at all. | Block any scale claim; CRUS fiscal sustainability and any tax-replacement language remain unproven until a costed, debasement-bounded model exists. |
| 11 | A cyber drill (ransomware, key compromise, regional outage) interrupts floor delivery beyond a published continuity tolerance, or no availability control is specified. | Treat availability as unaddressed; specify and test cyber-resilience and offline continuity before launch. |
| 12 | A person who cannot enroll in or hold a digital credential has no tested path to the survival floor. | Block universality claims; specify and pilot an analog floor-of-last-resort path. |
| 13 | The monitoring required for enforcement is shown to be repurposable for surveillance beyond its stated bounds, with no limiting control. | Document the residual openly; do not claim the design "prevents" the surveillance it structurally requires. |
...
| Governance usability and ordinary challenger parity review | Quarterly pre-launch simulation, then each governance cycle | Capture Dashboard Specification; Founding Legitimacy Dossier; Jurisdiction Interface Clause; Annexes AI, AM, Z | Filing share, response parity, win/partial-win rate, abandonment, expert-help dependency, interim protection, remedy delivery, retaliation, and repeat-insider concentration. |
...
| CRUS fiscal/incidence review | Before any CRUS activation, tax-replacement claim, or ordinary-tax-narrowing claim; then annually if active | Commons Return and Universal Stake Evidence Test Package; Parameter Calibration Register CRUS gates; Annex D; Annex X | Net source receipts, named obligation, pass-through, downturn stress, avoidance leakage, administrative cost, capture signals, work-incentive response, dignity findings, and claim-status update. |
