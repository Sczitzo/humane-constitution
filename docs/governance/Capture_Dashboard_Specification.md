...
| Commons Return incidence by class | Detect hidden ordinary-life tax. | Ordinary households, caregivers, small operators, renters, residents with modest homes, or vulnerable groups pay more relative burden than scarcity privilege, public-created value, or concentrated control. |
| Universal Stake timing and formula changes | Detect political dividend capture. | Distribution cadence, formula changes, or reserve drawdowns cluster around election cycles or incumbent messaging. |
| Public Commons Lockbox sufficiency | Detect fiscal hollowing. | Essential Access, resilience reserves, restoration duties, or payment rails are underfunded while distributions, prestige projects, or administrative growth continue. |
...
| Compliance-masked refusal exposure | Detect lawful-looking obstruction that degrades real CSM delivery. | Formal compliance coexists with slow confirmations, narrow performance, data withholding, standards delay, PBM access friction, affiliate routing, workforce poaching, or concession pressure. |
...
| Last-resort no-credential access | Detect whether the survival floor reaches people outside identity and digital infrastructure. | A person without phone, wallet, card, app, document, stable address, biometric, account, or future-enrollment promise cannot receive the CSM floor. |
...
| Money, Procurement & Legal Wrapper | Essential-sector refusal exposure | Any largest-supplier, medicine/PBM, grid, logistics, or data-infrastructure drill produces a positive gap window before fallback activation | CSM floor breach, reserve exhaustion before fallback activation, or continuation requiring concession to the incumbent |
| Money, Procurement & Legal Wrapper | Compliance-masked refusal exposure | Any essential-sector drill records formal compliance plus one material obstruction: missed CSM service-level baseline, data/control-system export delay, standards-body obstruction, PBM access friction, affiliate fallback correlation, workforce poaching, selective regional degradation, legal delay beyond 14 days, or concession request | Repeated obstruction across 2+ categories or periods, any vulnerable cohort loses CSM continuity, CASP activation is blocked, or fallback control transfer fails because of incumbent-linked data, staff, software, affiliate, standards, PBM, financing, or subcontractor dependency |
...
| Identity & Access Gatekeeping | Last-resort no-credential access | Any no-credential drill requires phone, app, card, account, biometric, stable address, identity-disclosing intermediary, or future enrollment promise | Any tracked CSM category lacks a no-credential route, abandonment is not counted, analog records become a persistent registry, or any vulnerable cohort cannot obtain the floor during a drill |
