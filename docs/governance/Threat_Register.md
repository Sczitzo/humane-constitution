...
- **Cross-instrument convertibility red team:** Isolated lane tests are insufficient. The live test must include bundled attacks where an employer, landlord, lender, platform, household controller, broker, or local administrator combines housing access, job access, debt relief, identity-recovery help, Universal Stake assignment pressure, Essential Access proxy redemption, Voice pooling, and Service Record disclosure into one informal exchange. Any repeatable bundle that makes survival, civic standing, identity recovery, or member distribution practically tradable is a blocking failure, even if no single lane shows a formal ledger breach.
...
- **Compound linkages:** T-025 × T-001 if Universal Stake or Commons Return credits become above-ledger collateral or part of a bundled informal exchange. T-025 × T-004/T-008 if Service Record status, attestation access, or reviewer networks become the price of eligibility help. T-025 × T-007 if source-base definitions drift. T-025 × T-028 if essential-sector firms use concessions, patents, logistics, or foreign affiliates to preserve scarcity rents.
