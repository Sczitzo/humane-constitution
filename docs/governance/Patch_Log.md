...
- **Gate 1 drill evidence (simulation level, 2026-07-13):** [RAS Allocation Drill 001](../simulations/RAS_Allocation_Drill_001.md) — at every tested capacity (95/85/70/50% of aggregate need), RAS-1 pro-rata yields uniform fulfillment with no person zeroed, while flat per-capita cuts leave lactating mothers at 39% of their minimum at half capacity and no-rule random rotation zeroes 50% of the population outright. Gates 2–6 remain unexecuted.
