...
> | | |
> |---|---|
> | **What this is** | A plain-language tour of problems that keep breaking societies, and the real attempts to solve them. |
> | **Who it is for** | Anyone new to this project, and anyone who thinks "this has been tried and it failed." |
...
The chapters do not build on each other. You can start with any one of them. Each opens with a problem, follows it through real cases, and ends by pointing you to the part of this project that responds. Read in order, or skip to what you care about.

Three failure modes come up again and again. We give each one a plain name:

- **Survival-Trade Bind** — when staying alive depends on the market. If food, shelter, and medicine can only be bought, then losing your place in the market means losing your life.
- **Power-Wealth Convergence** — when wealth turns into power. Past a certain point, money buys laws, offices, and the rules themselves. The wealthy then use that power to protect their wealth.
- **Static-Advantage Loop** — when advantage passes down unchanged. Each generation inherits the last one's head start or its hole. Over time, that hardens into something that looks like caste.

One more thing shows up across the record, and we state it as an observation, not a belief. Across societies that never contacted each other, a shared moral-accountability framework — something that holds leaders answerable to a standard beyond their own interest — keeps appearing as a stabilizing factor. When it holds, institutions tend to correct toward serving people. When it erodes or gets captured, they drift toward the failures these chapters describe. This is a pattern in how institutions behave. It is not a claim that any religion is true or endorsed.

The chapters end with pointers into the rest of this project. They name the instrument or governance document that responds to each problem — Essential Access, Flow, Voice, Service Record, Shared Storehouse, and the governance files that track what is still unsolved. Follow those pointers when you want to see how the design answers the history.

A plain word before you start. This project does not claim to have solved these problems. It claims to have studied them carefully enough to try.

## Chapter 1 — When survival depends on the market

A person can do everything right and still lose. They work. They follow the rules. Then the job ends, or the price of food climbs, or they get sick. If food, shelter, and medicine can only be bought, then losing your place in the market means losing your life.

This is the trap. Markets move resources toward people who can pay. That is what they are built to do. But a market has no way to stop a person from dying at the bottom. It has no floor. When you cannot pay, the market does not catch you. It simply moves on to the next buyer.

The absence of a floor is a choice. It is not a law of nature. Societies have built floors before, and societies have torn them down. The record below shows both.

### The Irish Famine (1845–52)

A potato blight destroyed the food that most poor Irish families lived on. But Ireland did not run out of food. Other food — grain, cattle, butter — kept being grown, and kept being shipped out of the country for sale abroad, while people in the same towns starved.[^c1-1]

This was the market working exactly as designed. The food went to those who could pay for it. Buyers abroad could pay. Starving tenants could not. British ships carried Irish food out of ports like Cork while ships carrying starving emigrants passed them going the other way.[^c1-2]

What was tried: the British government held to a belief that the state should not interfere with trade. So it did little to keep food in the country or to put a floor under the people losing everything.[^c1-3] What failed was the whole arrangement. There was no floor beneath market failure, and the government's ideology was the reason there was none.

The cost: roughly one million people died. About two million more emigrated within five years. Ireland lost around a quarter of its population in a decade.[^c1-4]

The lesson is not that markets are evil. It is narrower and harder. A market has no built-in way to prevent death at the bottom. When no one builds a floor on purpose, there is no floor.

### Brief cases

**New Deal food and work programs (United States, 1933–39).** During the Great Depression, the US government tried a floor: it hired people directly, handed out food, and propped up farm prices.[^c1-5] It worked while it ran. Then political pressure cut the programs early. Opponents called them socialism, and the floor partly vanished. The pattern: a floor helps people while it exists, and it gets attacked by those who do better when it is gone.

**Post-Soviet collapse (Russia, 1991–98).** The Soviet system had guaranteed work, housing, and food. When it fell, those guarantees were removed almost overnight. Life expectancy dropped sharply over the decade that followed.[^c1-6] The floor was pulled away on ideological grounds. The people who pulled it away did not have to live without one.

**Gig-economy precarity (2010s–present).** Income that swings month to month, with no floor underneath it. App-based work classifies people as contractors, not employees. The worker carries all the risk of a slow week; the platform keeps the steady part. Studies link this volatility to housing instability, medical debt, and mental-health strain.[^c1-7]
...
> - People skipping meals or medical care because they cannot afford them, and food-bank use climbing even while the economy is said to be growing.
> - The phrase "personal responsibility" used to explain why people are going hungry.
