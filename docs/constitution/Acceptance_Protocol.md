...
| **Pilot representativeness assessment published (AG1)** | ANNEX_AG §AG1; P-013 | Before any patch enters pilot status: the founding team has published a representativeness assessment for the proposed pilot region against the four-dimension bias check required by §AG1 — fraud pressure, institutional trust, demographic composition, and infrastructure capacity — each measured against the national median. If the region is flagged on more than one dimension, a second stress-tested region must be designated before evidence from that pilot is considered complete. This gate must be cleared separately for each proposed pilot region; it is not a one-time founding gate. This gate does not require full ANNEX_AG activation — §AG1 binds as a pre-pilot requirement regardless of ANNEX_AG's PROPOSED status. | ANNEX_AG §AG1 |
