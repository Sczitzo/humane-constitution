...
- **No taxes on ordinary life:** survival access, ordinary labor, and basic household exchange may not be taxed as routine revenue sources. This does not prove that all other taxes can disappear; any remaining taxes or fees must be named, costed, and screened against this invariant.
...
**Core framing**
- **Money should move:** Flow is designed to serve real exchange and production, not pile up forever; this does not authorize routine balance decay on ordinary savings.
...
- **Anti-hoarding rule:** Flow does not carry routine balance decay or progressive net-worth demurrage by default. Idle or stale-purpose Flow is disciplined through Annex X issuance limits, protected-float rules, stale-purpose quarantine, anti-broker enforcement, and Annex D Commons Return source-base review where the holding reflects public-created value, scarcity privilege, legal monopoly, resource use, large succession, or protected-commons extraction. Ordinary saving, working liquidity, and modest household continuity are protected.
- **Banking rule:** basic payments, custody, wage receipt, transfers, and cash access are designed to operate on public infrastructure funded through Article V public finance and commons revenue (PFCR), subject to the T-029/P-066 fiscal adequacy gate and public-rail cost model; any licensed retail provider serving the public must offer the baseline public banking floor on the common rail.
- **Investment channel:** contract-commitment treatment is not a balance shelter. Time-bound project escrows, build accounts, term-finance pools, catastrophe reserves, and public infrastructure windows avoid stale-purpose quarantine only while funds remain preregistered, ring-fenced, milestone-reviewed by independent auditors, subject to reversion if purpose drifts or deadlines become circular, and reviewed under Annex D where a Commons Return source base is implicated. No holder receives protected treatment merely by labeling funds as investment.
...
- **Revenue constitution:** public operations are designed to be funded through Commons Return source-base receipts, commons and land-use charges, scarce-license and gateway fees, public-infrastructure uplift, and bounded public issuance tied to real public production — not through taxes on survival, ordinary labor, or basic household exchange. This remains subject to the T-029/P-066 fiscal adequacy gate, remaining-tax disclosure, burden-incidence review, and debasement tolerance. (The no-taxes-on-ordinary-life rule itself is an Article I Tier 1 invariant; PFCR is the preferred revenue mechanism that must prove it can make the rule operationally coherent.)
- **Public banking infrastructure:** the payment rail, basic custody, wage receipt, cash conversion, and fraud-recovery floor are designed to be funded as public infrastructure with a guaranteed postal-bank or public-bank option and interoperable licensed providers, subject to a public-rail cost model and remaining-tax disclosure. Any licensed retail provider serving the public must offer the baseline public banking floor on the common rail.
