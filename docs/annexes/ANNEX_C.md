...
All material changes to Essential Access basket, scarcity triggers, Commons Return source-base rules, Universal Stake distribution rules, Voice scope, Service Record service eligibility rules, or identity/oracle mechanisms must use a controlled change process.
