...
| :--- | :--- | :--- | :--- |
| **Tier 1 - Constitutional invariants** | Human dignity, due process, unconditional survival floor, Flow/Essential Access/Voice and Service Record/Shared Storehouse non-convertibility, no social score, privacy limits, anti-capture boundaries. | Only through constitutional amendment. | Multi-cycle public notice, supermajority approval, independent constitutional review, cooling-off period, and explicit rights-impact statement. |
...
| **Remittances and gifts** | Flow may be sent outward from lawful earnings through declared gateways. | Outbound Essential Access/Voice and Service Record transfer, bundled coercive labor contracts, or hidden cross-border compensation for civic acts. | Transaction reporting thresholds, labor review, anomaly detection. |
...
| **Voice and Service Record attribution / contribution verification** | Contribution registry review with verifier challenge file. | Independent civic adjudicator; constitutional review if structural bias is alleged. | Re-score, nullification of fraudulent attestations, verifier penalties, published correction. |
