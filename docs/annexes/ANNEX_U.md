...
- If milestones are vague, circular, self-scored, or repeatedly deferred without justified cause, or materially disconnected from declared purpose, protected treatment ends and the balance reverts to ordinary Flow treatment plus Commons Return / avoidance-shell review.
