# Annex Taxonomy — Reader-Facing Schema

## Status and scope

This file is a **reader-facing design artifact**. It is not operative constitutional text, not corpus-registered, and not referenced by any build script.
...
- ANNEX_D is and remains the canonical Commons Return and Universal Stake instrument.
...
- One decimal code per annex. Each annex has exactly one primary Title assignment.
- Cross-references are notes, not duplicate rows.
- Legacy letter gaps are preserved. They are not filled for neatness.
- Decimal codes organize reader navigation; they do not change constitutional meaning.
- Future migration to INDEX.md or filename aliasing requires separate approval.
...
| 4 | Economy and Stewardship |
| 5 | Oracles, Measurement, and Supply Data |
| 6 | Emergency and Continuity |
| 7 | Evidence, Audits, and Pilots |
| 8 | Threats and Hardening |
...
Constitutional mechanics: how rules change, how the system legitimately begins.
...
Who is protected, how identity is established, and what floor of provision is guaranteed.

| Decimal | Legacy ID | Title |
|---|---|---|
| 2.1 | ANNEX_I | Residency, Migration, and Onboarding Article |
...
| Decimal | Legacy ID | Title |
|---|---|---|
| 3.1 | ANNEX_L | Judicial Architecture and Constitutional Review Institutions |
...
Money creation, commons returns, universal stake, investment containment, and trade boundaries.
...
| Decimal | Legacy ID | Title |
|---|---|---|
| 7.1 | ANNEX_A | Adversarial Test Suite |
| 7.2 | ANNEX_AG | Formal Acceptance Process Integrity Clauses |
...
These annexes have significant secondary relevance outside their primary Title. Cross-references are informational only; the decimal code does not change.

| Annex | Primary | Secondary relevance |
|---|---|---|
...
The following letters have no corresponding annex file. **Gaps should not be filled merely for neatness.** Each gap reflects intentional consolidation or was never assigned.

| Missing ID | Disposition |
|---|---|
| E | Never assigned. |
| F | Never assigned. |
| G | Merged: §G2 boundary membrane → ANNEX_V; §G4 public finance → ANNEX_X. Retired 2026-04-25. |
| J | Content distributed into ANNEX_X (issuance channels) and ANNEX_AR (investment containment). Retired 2026-04-25. |
| O | Superseded by ANNEX_AJ (side-deal examples) and ANNEX_Q (transition doctrine). Retired 2026-04-25. |
| R | Merged: investment content → J (now distributed into X and AR); bypass content → ANNEX_U. Retired 2026-04-25. |
| W | Merged into ANNEX_P (proof-of-personhood). Retired 2026-04-25. |
| AA | Distributed: §AA3 intellectual property → ANNEX_X; §AA4 tier-3 drift and technical failure → ANNEX_T. Retired 2026-04-25. |
...
| Phase | Scope | Status |
|---|---|---|
| Phase 1 | TAXONOMY.md only — reader-facing design artifact, no corpus impact | **This document** |
| Phase 2 | If approved: add decimal code and Title columns to INDEX.md as display metadata | Requires separate approval |
| Phase 3 | If later approved: consider alias headers in annex files or filename migration | Requires separate approval; no filename migration is authorized by this artifact |

No build script, corpus export, or validation tooling references this file.
