...
**Status:** MIXED - P-016 identity asymmetric error doctrine is ACTIVE; AK8 / P-056 open-access survival floor provisions remain PROPOSED.
...
- **Evidence status:** Designed mechanism, needs evidence; P-016 doctrine is active-unproven, while AK8 / P-056 remains proposed. FC-140 has provisional anchors, and FC-141 through FC-150 still need pilot-calibrated commitments before scale.
