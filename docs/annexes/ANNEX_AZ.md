...
> **Scope note.** This annex previously contained a progressive net-worth demurrage architecture (§AZ1–AZ3). That content is superseded by [ANNEX_D](./ANNEX_D.md), which now governs Commons Return and Universal Stake. This annex now exists only for the Tier 0 token mechanism constitutional framework (§AZ1 below). No active demurrage content is present or intended here.

> **Provenance.** §AZ2.1 was originally drafted in the P0-A adversarial audit remediation batch (2026-05-15) to resolve the pre-operational gate in INV-LAUNCH-1. The demurrage sections (former §AZ1–AZ3) were deleted and later superseded by the Annex D Commons Return and Universal Stake rewrite; §AZ2.1 was not demurrage content and was restored here to keep the INV-LAUNCH-1 gate intact.
