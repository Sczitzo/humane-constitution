...
- **Induced-deadlock review:** The arbitration panel assesses, including in real time as it constitutes the temporary baseline, whether either blocking process was initiated or sustained in bad faith or to gain strategic advantage — including to force a smaller or faster arbitration forum or to weaponize the scope freeze. A rebuttable presumption of bad faith applies to any party that benefits from the scope freeze or from the contested classification's pendency; that party bears the burden of showing its process was a genuine, independent, good-faith objection. A deadlock found to be deliberately induced is void: the inducing party's blocking process is dissolved, normal channels resume, and the inducing party is referred for enforcement. The arbitration panel and the root-cause review apply the same bad-faith and strategic-advantage test; the root-cause review confirms or revises the panel's real-time finding on the full record.
- **Scope freeze:** No expansion of powers, no new Shared Storehouse activations, no new PCRP activations during the deadlock period. The scope freeze does not bar a survival-floor-protective activation that the arbitration panel certifies as unrelated to the contested classification: a genuinely new and independent survival emergency arising mid-deadlock is met as if no deadlock existed. The freeze stops power expansion and entrenchment of advantage; it never blocks unrelated life-safety aid.
- **Mandatory root-cause review:** Post-resolution post-mortem identifies which procedural rules enabled the triple-block, whether either blocking process was deliberately induced, and whether amendment is required.
...
**Level 5 minimum procedure:** Level 5 structural review is a constitutional convention invoked when both the primary governance channel and the arbitration panel have failed simultaneously. Because the bodies normally responsible for convening a convention may themselves be parties to the deadlock, Level 5 must not require the consent of any body already blocked. The following minimum procedure applies: (a) *Convening authority:* the Federated Ombuds Plenum — which is operationally independent of the CRP and the governing coalition — convenes the Level 5 panel by 3-of-5 vote within 24 hours of the second-generation deadlock being declared. If the Ombuds Plenum is also deadlocked, the IIA (ANNEX_AK §8) and the standing adversarial panel member (ANNEX_AV §AV3) jointly issue a written convening notice and the Plenum is constituted from reserve members. Because this last-resort path concentrates extraordinary convening power in two officeholders at peak stress, each is barred from acting as convener where they are a party to the underlying deadlock, stand to gain from the contested classification or the scope freeze, or hold a direct interest — financial, factional, or personal — in its outcome; the bar extends to any convener within one degree of such interest. A convener who is conflicted, or whom either body's standing recusal review finds conflicted, must recuse and state the basis in writing. A recused or unavailable IIA officer is replaced by the named Deputy IIA, and a recused or unavailable adversarial panel member by the named alternate panel member designated under ANNEX_AV §AV3; where both designated conveners are conflicted, the convening notice issues jointly from their named alternates. No convening notice is valid unless issued by two non-conflicted officeholders, and the recusal record is appended to the Level 5 file. (b) *Survival floor continuity during Level 5:* CSM issuance (ANNEX_Y §Y2) continues unconditionally. The Level 4 survival-floor bridge remains active and may not be suspended by Level 5 proceedings. (c) *Maximum clock:* if a Level 5 panel is not convened and seated within 72 hours, the Federated Ombuds Plenum issues a standing order maintaining the last-known CSM delivery baseline and the matter is escalated to the H-3 re-founding petition process (ANNEX_AH §AH5.1) without waiting for Level 5 resolution. The 72-hour clock is not waivable.
