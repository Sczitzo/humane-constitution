...
This annex carries the ownership architecture that keeps Article V's anti-rent and anti-extraction logic from being defeated by legal form. Where Annex D addresses Commons Return and Universal Stake — public return from shared value, scarcity rents, and large succession transfers — this annex addresses *control*: who ultimately owns, who succeeds to ownership, and on what terms capital may claim a return. It works alongside Annex D, Annex X §X8 (public finance and commons revenue), Annex AR (contract-commitment architecture), and Annex V (housing and land use-rights).
