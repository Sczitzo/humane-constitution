...
- **Governing clause - household savings floor duration:** This annex governs the demurrage-free household savings floor duration. The operative safe harbor period is 18 months of published regional median consumption expenditure, as stated in this section. Where the Humane Constitution Section VIII, ANNEX_X Section X5, or any other corpus document states a different household demurrage-free safe harbor period, this annex controls for enforcement purposes until the constitutional text is formally reconciled through the applicable amendment process. This clause does not alter the demurrage rate, the enterprise operating-float exemption, or any other parameter in this section. It does not amend constitutional text by itself. It provides enforcement priority for this active annex specification pending formal reconciliation.
