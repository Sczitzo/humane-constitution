# First 60-Second Explainer

## Core script

Most systems force too much through one rail: money. The same money that decides whether you can eat or stay housed also helps decide who can invest, who gets influence, and who can shape institutions. That is how wealth turns into coercion.
...
- Speak it calmly, not like a pitch deck.
- Pause after: `money`, `coercion`, and `The point is simple`.
- Put the five instruments on screen as short labels while reading the middle section.
- End on the contrast: `Markets still function. Survival stays protected. Governance gets harder to purchase.`

## Shorter close variant
