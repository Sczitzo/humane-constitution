...
const DOC_PHRASE_DEFS: Array<{ phrases: string[]; path: string }> = [
  ...
  { phrases: ['Commons Return and Universal Stake Evidence Test Package', 'Commons Return Evidence Test Package', 'CRUS Evidence Test Package'], path: 'docs/governance/Commons_Return_Universal_Stake_Evidence_Test_Package.md' },
...
const READING_PATHS: ReadingPathDef[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { path: 'docs/annexes/ANNEX_X.md', note: 'How Flow (the currency) is issued. Notice how issuance is tied to real capacity rather than debt.' },
      ...
      { path: 'docs/annexes/ANNEX_D.md', note: 'Commons Return and Universal Stake — the public-return system for shared value, scarcity rents, succession transfers, and the protected civic inheritance that replaces routine demurrage as the active wealth spine.' },
